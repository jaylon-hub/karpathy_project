...
def interleave_datasets(datasets: list[DatasetType], probabilities: Optional[list[float]] = ..., seed: Optional[int] = ..., info: Optional[DatasetInfo] = ..., split: Optional[NamedSplit] = ..., stopping_strategy: Literal[first_exhausted, all_exhausted, all_exhausted_without_replacement] = ...) -> DatasetType:
    """
...
def concatenate_datasets(dsets: list[DatasetType], info: Optional[DatasetInfo] = ..., split: Optional[NamedSplit] = ..., axis: int = ...) -> DatasetType:
    """
