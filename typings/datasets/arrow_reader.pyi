...
def make_file_instructions(name: str, split_infos: list[SplitInfo], instruction: Union[str, ReadInstruction], filetype_suffix: Optional[str] = ..., prefix_path: Optional[str] = ...) -> FileInstructions:
...
class BaseReader:
    ...
    """
    def __init__(self, path: str, info: Optional[DatasetInfo]) -> None:
    ...
    def get_file_instructions(self, name, instruction, split_infos): # -> list[dict[Any, Any]]:
        """Return list of dict {'filename': str, 'skip': int, 'take': int}"""
        ...
    
    def read(self, name, instructions, split_infos, in_memory=...): # -> dict[str, Any]:
    ...
    def read_files(self, files: list[dict], original_instructions: Union[None, ReadInstruction, Split] = ..., in_memory=...): # -> dict[str, Any]:
...
class ArrowReader(BaseReader):
    ...
    @staticmethod
    def read_table(filename, in_memory=...) -> Table:
        """
...
class ReadInstruction:
    ...
    """
    def __init__(self, split_name, rounding=..., from_=..., to=..., unit=...) -> None:
    ...
    @classmethod
    def from_spec(cls, spec): # -> ReadInstruction:
    ...
    def to_spec(self): # -> LiteralString:
        ...
    ...
    def to_absolute(self, name2len): # -> list[_AbsoluteInstruction]:
