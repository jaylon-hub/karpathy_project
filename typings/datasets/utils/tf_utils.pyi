...
def minimal_tf_collate_fn(features): # -> dict[Any, Any]:
    ...

def minimal_tf_collate_fn_with_renaming(features): # -> dict[Any, Any]:
    ...

def is_numeric_pa_type(pa_type): # -> bool:
    ...

def np_get_batch(indices, dataset, cols_to_retain, collate_fn, collate_fn_args, columns_to_np_types, return_dict=...): # -> dict[Any, Any] | list[Any]:
    ...

def dataset_to_tf(dataset, cols_to_retain, collate_fn, collate_fn_args, columns_to_np_types, output_signature, shuffle, batch_size, drop_remainder): # -> Dataset[dict[Any, Any]]:
...
class SharedMemoryContext:
    ...
    def get_shm(self, name, size, create): # -> SharedMemory:
        ...
    
    def get_array(self, name, shape, dtype, create): # -> ndarray[_AnyShape, dtype[Any]]:
        ...
...
class NumpyMultiprocessingGenerator:
    ...
    def __iter__(self): # -> Generator[dict[Any, NDArray[Any]], Any, None]:
        ...
    ...
    @staticmethod
    def distribute_batches(dataset, batch_size, drop_remainder, num_workers, shuffle): # -> tuple[list[NDArray[signedinteger[Any]]], NDArray[signedinteger[Any]] | None, int | None]:
        ...
    


def multiprocess_dataset_to_tf(dataset, cols_to_retain, collate_fn, collate_fn_args, columns_to_np_types, output_signature, shuffle, batch_size, drop_remainder, num_workers): # -> Dataset[Any]:
