...
def approximate_mode(class_counts, n_draws, rng): # -> Any:
...
def stratified_shuffle_split_generate_indices(y, n_train, n_test, rng, n_splits=...): # -> Generator[tuple[Any, Any], Any, None]:
    """
