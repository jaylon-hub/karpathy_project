...
from .features.features import FeatureType, Features

if TYPE_CHECKING:
    ...
logger = ...
def inject_arrow_table_documentation(arrow_table_method): # -> Callable[..., Any]:
    ...
...
class IndexedTableMixin:
    ...
    def fast_slice(self, offset=..., length=...) -> pa.Table:
        """
...
class Table(IndexedTableMixin):
    ...
    def to_reader(self, max_chunksize: Optional[int] = ...):
        """
...
class InMemoryTable(TableBlock):
    ...
    @classmethod
    def from_buffer(cls, buffer: pa.Buffer): # -> Self:
        ...
    
    @classmethod
    def from_pandas(cls, *args, **kwargs): # -> Self:
        """
    ...
    @classmethod
    def from_arrays(cls, *args, **kwargs): # -> Self:
        """
    ...
    @classmethod
    def from_pydict(cls, *args, **kwargs): # -> Self:
        """
    ...
    @classmethod
    def from_pylist(cls, mapping, *args, **kwargs): # -> Self:
        """
    ...
    @classmethod
    def from_batches(cls, *args, **kwargs): # -> Self:
        """
    ...
    def slice(self, offset=..., length=...): # -> InMemoryTable:
        """
        Compute zero-copy slice of this Table.
    ...
    def filter(self, *args, **kwargs): # -> InMemoryTable:
        """
        Select records from a Table. See `pyarrow.compute.filter` for full usage.
        """
        ...
    
    def flatten(self, *args, **kwargs): # -> InMemoryTable:
        """
        Flatten this Table.  Each column with a struct type is flattened
        into one column per struct field.  Other columns are left unchanged.
    ...
    def combine_chunks(self, *args, **kwargs): # -> InMemoryTable:
        """
        Make a new table by combining the chunks this table has.
    ...
    def cast(self, *args, **kwargs): # -> InMemoryTable:
        """
        Cast table values to another schema.
    ...
    def replace_schema_metadata(self, *args, **kwargs): # -> InMemoryTable:
        """
        EXPERIMENTAL: Create shallow copy of table by replacing schema
        key-value metadata with the indicated new metadata (which may be `None`,
        which deletes any existing metadata).
    ...
    def add_column(self, *args, **kwargs): # -> InMemoryTable:
        """
        Add column to Table at position.
    ...
    def append_column(self, *args, **kwargs): # -> InMemoryTable:
        """
        Append column at end of columns.
    ...
    def remove_column(self, *args, **kwargs): # -> InMemoryTable:
        """
        Create new Table with the indicated column removed.
    ...
    def set_column(self, *args, **kwargs): # -> InMemoryTable:
        """
        Replace column in Table at position.
    ...
    def rename_columns(self, *args, **kwargs): # -> InMemoryTable:
        """
        Create new table with columns renamed to provided names.
        """
        ...
    
    def drop(self, *args, **kwargs): # -> InMemoryTable:
        """
        Drop one or more columns and return a new table.
    ...
    def select(self, *args, **kwargs): # -> InMemoryTable:
        """
        Select columns of the table.
...
class MemoryMappedTable(TableBlock):
    ...
    @classmethod
    def from_file(cls, filename: str, replays=...): # -> Self:
        ...
    ...
    def slice(self, offset=..., length=...): # -> MemoryMappedTable:
        """
        Compute zero-copy slice of this Table.
    ...
    def filter(self, *args, **kwargs): # -> MemoryMappedTable:
        """
        Select records from a Table. See `pyarrow.compute.filter` for full usage.
        """
        ...
    
    def flatten(self, *args, **kwargs): # -> MemoryMappedTable:
        """
        Flatten this Table.  Each column with a struct type is flattened
        into one column per struct field.  Other columns are left unchanged.
    ...
    def combine_chunks(self, *args, **kwargs): # -> MemoryMappedTable:
        """
        Make a new table by combining the chunks this table has.
    ...
    def cast(self, *args, **kwargs): # -> MemoryMappedTable:
        """
        Cast table values to another schema
    ...
    def replace_schema_metadata(self, *args, **kwargs): # -> MemoryMappedTable:
        """
        EXPERIMENTAL: Create shallow copy of table by replacing schema
        key-value metadata with the indicated new metadata (which may be None,
        which deletes any existing metadata.
    ...
    def add_column(self, *args, **kwargs): # -> MemoryMappedTable:
        """
        Add column to Table at position.
    ...
    def append_column(self, *args, **kwargs): # -> MemoryMappedTable:
        """
        Append column at end of columns.
    ...
    def remove_column(self, *args, **kwargs): # -> MemoryMappedTable:
        """
        Create new Table with the indicated column removed.
    ...
    def set_column(self, *args, **kwargs): # -> MemoryMappedTable:
        """
        Replace column in Table at position.
    ...
    def rename_columns(self, *args, **kwargs): # -> MemoryMappedTable:
        """
        Create new table with columns renamed to provided names.
        """
        ...
    
    def drop(self, *args, **kwargs): # -> MemoryMappedTable:
        """
        Drop one or more columns and return a new table.
    ...
    def select(self, *args, **kwargs): # -> MemoryMappedTable:
        """
        Select columns of the table.
...
class ConcatenationTable(Table):
    ...
    @classmethod
    def from_tables(cls, tables: list[Union[pa.Table, Table]], axis: int = ...) -> ConcatenationTable:
    ...
    def slice(self, offset=..., length=...): # -> ConcatenationTable:
        """
        Compute zero-copy slice of this Table.
...
def concat_tables(tables: list[Table], axis: int = ...) -> Table:
    """
    Concatenate tables.
...
def array_cast(array: pa.Array, pa_type: pa.DataType, allow_primitive_to_str: bool = ..., allow_decimal_to_str: bool = ...) -> Union[pa.Array, pa.FixedSizeListArray, pa.ListArray, pa.StructArray, pa.ExtensionArray]:
...
@_wrap_for_chunked_arrays
def cast_array_to_feature(array: pa.Array, feature: FeatureType, allow_primitive_to_str: bool = ..., allow_decimal_to_str: bool = ...) -> pa.Array:
...
@_wrap_for_chunked_arrays
def embed_array_storage(array: pa.Array, feature: FeatureType, token_per_repo_id=...):
...
def embed_table_storage(table: pa.Table, token_per_repo_id=...):
...
def table_visitor(table: pa.Table, function: Callable[[pa.Array], None]): # -> None:
...
def table_iter(table: Table, batch_size: int, drop_last_batch=...) -> Iterator[pa.Table]:
